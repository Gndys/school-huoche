<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电影名称" prop="yingpianmingcheng">
          <el-input v-model="ruleForm.yingpianmingcheng" 
              placeholder="电影名称" clearable  :readonly="ro.yingpianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="电影名称" prop="yingpianmingcheng">
              <el-input v-model="ruleForm.yingpianmingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="影院" prop="yingyuan">
          <el-input v-model="ruleForm.yingyuan" 
              placeholder="影院" clearable  :readonly="ro.yingyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="影院" prop="yingyuan">
              <el-input v-model="ruleForm.yingyuan" 
                placeholder="影院" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="放映厅" prop="fangyingting">
          <el-input v-model="ruleForm.fangyingting" 
              placeholder="放映厅" clearable  :readonly="ro.fangyingting"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="放映时间" prop="fangyingshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.fangyingshijian" 
                type="datetime"
                placeholder="放映时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fangyingshijian" label="放映时间" prop="fangyingshijian">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="时长" prop="shichang">
          <el-input v-model="ruleForm.shichang" 
              placeholder="时长" clearable  :readonly="ro.shichang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="时长" prop="shichang">
              <el-input v-model="ruleForm.shichang" 
                placeholder="时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="座位数" prop="zuoweishu">
          <el-input v-model="ruleForm.zuoweishu" 
              placeholder="座位数" clearable  :readonly="ro.zuoweishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="座位数" prop="zuoweishu">
              <el-input v-model="ruleForm.zuoweishu" 
                placeholder="座位数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='yingpianmingcheng'){
            this.ruleForm.yingpianmingcheng = obj[o];
	    this.ro.yingpianmingcheng = true;
            continue;
          }
          if(o=='yingyuan'){
            this.ruleForm.yingyuan = obj[o];
	    this.ro.yingyuan = true;
            continue;
          }
          if(o=='fangyingting'){
